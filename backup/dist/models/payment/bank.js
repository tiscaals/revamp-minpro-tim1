...
__decorate([
    ...
    (0, sequelize_typescript_1.Index)({ name: 'bank_pkey', using: 'btree', unique: true }),
    __metadata("design:type", Number)
], bank.prototype, "bank_entity_id", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ allowNull: true, type: sequelize_typescript_1.DataType.STRING(10) }),
    (0, sequelize_typescript_1.Index)({ name: 'bank_bank_code_key', using: 'btree', unique: true }),
...
__decorate([
    ...
    (0, sequelize_typescript_1.Index)({ name: 'bank_bank_name_key', using: 'btree', unique: true }),
    __metadata("design:type", String)
...
], bank.prototype, "bank_modified_date", void 0);
bank = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'bank', schema: 'payment', timestamps: false })
], bank);
exports.bank = bank;
