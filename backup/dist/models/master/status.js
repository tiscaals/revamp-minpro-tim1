...
__decorate([
    ...
    (0, sequelize_typescript_1.Index)({ name: 'status_pkey', using: 'btree', unique: true }),
...
], status.prototype, "status_modified_date", void 0);
status = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'status', schema: 'master', timestamps: false })
], status);
