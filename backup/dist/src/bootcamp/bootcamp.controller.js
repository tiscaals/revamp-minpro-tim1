...
], BootcampController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], BootcampController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], BootcampController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], BootcampController.prototype, "update", null);
__decorate([
    (0, common_1.Patch)('status/:id/:status'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Param)('status')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], BootcampController.prototype, "changeStatus", null);
__decorate([
    (0, common_1.Post)('evaluation'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_bootcamp_dto_1.CreateBootcampDto]),
    __metadata("design:returntype", void 0)
], BootcampController.prototype, "createEvaluationWeek", null);
BootcampController = __decorate([
    (0, common_1.Controller)('bootcamp'),
    __metadata("design:paramtypes", [bootcamp_service_1.BootcampService])
], BootcampController);
exports.BootcampController = BootcampController;
//# sourceMappingURL=bootcamp.controller.js.map