...
ALTER TABLE ONLY payment.users_account
    ADD CONSTRAINT users_account_pkey PRIMARY KEY (usac_entity_id, usac_user_entity_id);
...
ALTER TABLE ONLY payment.transaction_payment
    ADD CONSTRAINT transaction_payment_trpa_source_id_fkey FOREIGN KEY (trpa_source_id) REFERENCES users.users(user_entity_id);
...
ALTER TABLE ONLY payment.transaction_payment
    ADD CONSTRAINT transaction_payment_trpa_target_id_fkey FOREIGN KEY (trpa_target_id) REFERENCES users.users(user_entity_id);
