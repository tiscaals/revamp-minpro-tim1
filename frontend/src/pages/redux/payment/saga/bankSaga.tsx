...
function* handlegetAllBank(): any {
  // console.log("result");
  try {
    const result = yield call(apimethod.findAllBank);
...
function* handleAddBank(action: any): any {
  // console.log("object");
  try {
    const result = yield call(apimethod.createBank, action.payload);
    // console.log("object");
...
function* handleUpdateBank(action: any): any {
  // console.log(action);
  try {
    const result = yield call(apimethod.updateByIdBank, action.payload);
    // console.log("object");
...
function* handleDeleteBank(action: any): any {
  try {
    const result = yield call(apimethod.deleteByIdBank, action.payload);
