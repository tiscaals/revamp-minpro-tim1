  ...
  return (
    <>
      <Button
        ...
        size="sm"
        variant="outlined"
        className="lg:hidden mb-5 flex items-center gap-3 justify-center"
        onClick={() => {
          setOpenNav(!openNav);
        }}
      >
      ...
      <div
        className={`lg:flex lg:pr-5 lg:pb-5 ${openNav ? 'flex m-5' : 'hidden'}`}
      >
        <div
          className={`overflow-y-auto h-[32rem] block items-center border lg:p-5 lg:py-1 ${
            openNav ? 'w-full justify-center' : 'w-[22rem]'
          }`}
        >
