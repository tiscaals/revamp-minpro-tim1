...
const TopBar = ({ showNav, setShowNav }: any) => {
  ...
  return (
    ...
    >
      <div className="pl-4 md:pl-2 md:pt-7">
        <Bars3CenterLeftIcon
            ...
            <Menu.Items className="absolute right-0 w-56 z-50 mt-2 origin-top-right bg-white rounded shadow-sm">
              <div className="p-1">
                <Menu.Item>
                  <Link
                    href="#"
                    className="flex hover:bg-green-500 hover:text-white text-gray-700 rounded p-2 text-sm group transition-colors items-center"
                  >
                ...
                <Menu.Item>
                  <button
                    className="w-full flex hover:bg-green-500 hover:text-white text-gray-700 rounded p-2 text-sm group transition-colors items-center"
                    onClick={logout}
                  >
