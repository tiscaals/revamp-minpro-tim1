    ...
    switch (decoded.role_id) {
      ...
      case 6:
        setListMenu([
          ...
          { to: '/curriculum', path: '/curriculum', icon:<MdLibraryBooks/>, name:'Curriculum'},
          { to: '/assignment', path: '/assignment', icon:<MdAssignment/>, name:'Assignment'},
          { to: '/postinghiring', path: '/postinghiring', icon:<MdPostAdd/>, name:'Posting Hiring'}
          ])
        break;
      default:
        setListMenu([
