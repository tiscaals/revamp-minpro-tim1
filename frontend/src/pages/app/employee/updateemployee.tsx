...
const EditEmployee = (props: any) => {
  ...
  const { department, joro, message, refresh } = useSelector(
                      ...
                      <div className="flex flex-wrap -mx-3">
                        ...
                        <div className=" mt-12 right-8 text-sm">
                          <button
                           ...
                           className="uppercase p-3 rounded-lg mr-5 bg-blue-400 hover:bg-blue-800 text-white " type="submit">
                            Update
                          </button>

                          <button
                            onClick={props.closeModal}
                            className="uppercase p-3 rounded-lg bg-blue-400 hover:bg-blue-800 text-white"
                          >
                            Cancel
                          </button>
                        </div>
