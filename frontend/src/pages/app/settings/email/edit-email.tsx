...
const EditEmail = (props: any) => {
  ...
  const handleEditEmail = async (data: any) => {
    dispatch(dotRequestUpdateEmail(data));
    props.closeModal();
  };

  useEffect(() => {}, [handleEditEmail]);
                      ...
                      <div className=" bg-white py-6  m-auto w-full">
                        <div className="grid grid-cols-1 gap-4  m-auto">
                          <div className="col-span-1">
                            <input
                              type="hidden"
                              defaultValue={props.selectedEmail.pmail_id}
                              {...register(
                                'pmail_id',
                                addEmailValidation.pmail_id
                              )}
                            />
                            <div className="w-full mt-2 mb-2 relative">
                              <Input
                                ...
                                defaultValue={props.selectedEmail.pmail_address}
                                autoComplete="off"
                              />
