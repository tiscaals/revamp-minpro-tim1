...
const JobEdit = () => {
  ...
  let { job_detail ,refresh } = useSelector((state: any)=>state.JobPostReducers);
                      ...
                      <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <div className="grid grid-cols-2 w-full gap-4">
                          <DatePicker
                            ...
                            value={loadedData.jopo_start_date ? dayjs(loadedData?.jopo_start_date) : startDate}
                          />
                          ...
                          <DatePicker
                            ...
                            value={loadedData.jopo_end_date ? dayjs(loadedData?.jopo_end_date) : startDate}
                          />
                        </div>
                        ...
                        <div className="flex">
                          ...
                          <label className="relative inline-flex items-center mb-4 cursor-pointer">
                            <input
                              ...
                              {...register("publish")}
                              defaultChecked={loadedData.jopo_status === "publish" ? true:false}
                        ...
                        <div className=" flex">
                          ...
                          <label className="relative inline-flex items-center mb-4 cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                              {...register("remote")}
                              defaultChecked={loadedData.jopo_joty_id === "1" ? true:false}
