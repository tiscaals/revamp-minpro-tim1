...
const EditCurr = () => {
  ...
  let { getCurrById, refresh } = useSelector(
    (state: any) => state.curriculumReducers
  );

  let { category, refreshCat } = useSelector(
  ...
  }, [id, refreshCat, refereshIns, refreshSectUp]);
  ...
  if (loadedData) {
    return (
      <ContentLink title="Edit Curriculum" isilink="/curriculum" button="Back">
        <div>
