...
const EditExperiences = (props: any) => {
  ...
  // const [isChecked, setIsChecked] = useState(props.selectedExperiences.usex_is_current === 1);
  // const [checkboxValue, setCheckboxValue] = useState(props.selectedExperiences.usex_is_current);
  ...
  const handleUpdateExperiences = async (data: any) => {
    // dispatch(doRequestUpdateExperiences(data));
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="">
                    <form onSubmit={handleSubmit(handleUpdateExperiences)}>
                      <div className=" bg-white py-6  m-auto w-full">
                        <div className="grid grid-cols-1 gap-4  m-auto">
                          <div className="col-span-1">
                            <input
                              type="hidden"
                              defaultValue={props.selectedExperiences.usex_id}
                              {...register('usex_id')}
                            />
                            <div className="w-full mt-2 mb-2 relative">
                              <Input
                                ...
                                defaultValue={
                                  props.selectedExperiences.usex_title
                                }
                                autoComplete="off"
                              />
                            ...
                            <div className="mt-2 mb-2 flex justify-between">
                              ...
                              <div className="w-full mt-5">
                                <Input
                                  ...
                                  defaultValue={
                                    props.selectedExperiences.usex_company_name
                                  }
                                  autoComplete="off"
                                />
                                <span className="text-sm text-red-600">
                            ...
                            <div className="mt-2 mb-2 flex justify-between">
                              <div className="w-full mr-3">
                                <Input
                                  ...
                                  defaultValue={
                                    props.selectedExperiences.usex_start_date
                                  }
                                />
                                <span className="text-sm text-red-600">
                              ...
                              <div className="w-full">
                                <Input
                                  ...
                                  defaultValue={
                                    props.selectedExperiences.usex_end_date
                                  }
                                />
                              </div>
                            ...
                            <div className="w-full mt-2 mb-2 relative">
                              <Input
                                ...
                                defaultValue={
                                  props.selectedExperiences.usex_industry
                                }
                                autoComplete="off"
                              />
                            </div>
                              ...
                              <div className="w-full mr-3">
                                ...
                                >
                                  ...
                                  <option
                                    ...
                                    selected={
                                      props.selectedExperiences
                                        .usex_employment_type === 'freelance'
                                    }
                                  >
                                    Freelance
                                  </option>
                              ...
                              <div className="w-full mr-3">
                                ...
                                >
                                  ...
                                  <option
                                    ...
                                    selected={
                                      props.selectedExperiences
                                        .usex_experience_type === 'certified'
                                    }
                                  >
                                    Certified
                                  </option>
                                  <option
                                    ...
                                    selected={
                                      props.selectedExperiences
                                        .usex_experience_type === 'voluntering'
                                    }
                                  >
                                    Voluntering
                                  </option>
                                  <option
                                    ...
                                    selected={
                                      props.selectedExperiences
                                        .usex_experience_type === 'organization'
                                    }
                                  >
                                    Organization
                                  </option>
                            ...
                            <div className="w-full mt-2 mb-2 relative">
                              <Textarea
                                ...
                                defaultValue={
                                  props.selectedExperiences.usex_description
                                }
                                autoComplete="off"
                              />
                              <span className="text-sm text-red-600">
