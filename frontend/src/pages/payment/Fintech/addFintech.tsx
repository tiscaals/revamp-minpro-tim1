...
import { doAddFintech, doadd } from '@/pages/redux/payment/action/actionReducer';
import Link from 'next/link';

const AddFintech = () => {
  // console.log("wadaw");
  let { fintech, message, refresh } = useSelector(
  ...
  const registerOptions = {
    ...
    fint_name: { required: 'fint_name is required' },
  };
