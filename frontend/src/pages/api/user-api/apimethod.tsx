...
//Profile Address
const getCity = () => {
  return axios.get('/profile-address/get-city');
};

const getAddressType = () => {
  return axios.get('/profile-address/address-type');
};

const addAddress = (data: any) => {
  return axios.post('/profile-address/add-address', data);
};
...
const removeAddress = (id: any) => {
  return axios.delete(`/profile-address/remove-address/${id}`, id);
};
