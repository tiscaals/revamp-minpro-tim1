            ...
            <div className="grid place-items-center mx-2  sm:my-auto">
                <div className="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 px-6 py-10 sm:px-10 sm:py-6 bg-white rounded-lg shadow-md lg:shadow-lg">
                    ...
                    <form className="mt-10" method="POST">
                        ...
                        <input id="username" type="username" name="email" placeholder="username" autoComplete="off"
                        ...
                        <label htmlFor="confirm_password" className="block mt-2 text-xs font-semibold text-gray-600 uppercase">Confirm password</label>
                        <input id="confirm_password" type="password" name="confirm_password" placeholder="confirm password" autoComplete="off"
                            className="block w-full py-3 px-1 mt-2 
                            text-gray-800 appearance-none 
                            border-b-2 border-gray-100
                            focus:text-gray-500 focus:outline-none focus:border-gray-200"
                        ...
                        <label htmlFor="phone_number" className="block mt-2 text-xs font-semibold text-gray-600 uppercase">Phone Number</label>
                        <input id="phone_number" type="phone_number" name="phone_number" placeholder="phone number" autoComplete="off"
                            className="block w-full py-3 px-1 mt-2
                            text-gray-800 appearance-none 
                            border-b-2 border-gray-100
                            focus:text-gray-500 focus:outline-none focus:border-gray-200"
                        ...
                        <Link href='/internal/signup' className='underline text-blue-800 text-sm'>If you are employee code.id, click this for signup</Link>
                        </div>
                    </form>
                </div>
            </div>
