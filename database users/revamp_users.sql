...
CREATE TABLE users.phone_number_type(
	...
	ponty_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP
)
...
CREATE TABLE users.roles(
	...
	role_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP
)
...
CREATE TABLE users.users(
	...
	user_birth_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
	user_email_promotion INTEGER DEFAULT 0,
	user_demographic JSON,
	user_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_phones(
	...
	uspo_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_education(
	...
	usdu_start_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	usdu_modified_data TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_media(
	...
	usme_modified_data TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_email(
	...
	pmail_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_license(
	...
	usli_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_skill(
	...
	uski_modified_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE users.users_experiences(
	...
	usex_start_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
	usex_end_date TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	usex_city_id INTEGER REFERENCES master.city(city_id),
